...
**טיקר (כל הדפים):** `MARKET_FALLBACK` הוא מקור האמת לריבית מדיניות ולפריים. אסור `updateDate: 'עכשיו'` או «המדד הנוכחי» בלי חודש. מדד: לתייג חודש למ״ס (או «דורש עדכון»). פריים תמיד = BoI + 1.5 (ספט׳ 2026: 3.25 → 4.75). לא להקשיח פריים 5.00% ליד מדיניות 3.25%.
